# UniUncer: Stage-2 training config for motion forecasting + planning.
# Loads Stage-1 weights and enables uncertainty-aware gating (with_ucer=True).
# ================ base config ===================
version = 'mini'
version = 'trainval'
...
# change to smaller batch size for limited GPU memory
total_batch_size = 24
num_gpus = 4
    ...
    head=dict(
        ...
        det_head=dict(
            ...
            loss_reg=dict(
                ...
                loss_box_l1=dict(type="L1Loss", loss_weight=0.25),
                loss_box_nll=dict(type="BoxNLLLoss", reduction='mean', loss_weight=0.6),
...
load_from = 'ckpt/uncer_stage1_iter_11720_1e-4.pth'